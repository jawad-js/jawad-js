...
## 💻 Tech Stack
<p align="left">
<img src="https://skillicons.dev/icons?i=html,css,js,react,tailwind,nodejs,express,mongodb,java,git,github,vscode,postman" />
</p>
...
### 🌱 [NayePankh Foundation Website Redesign](https://github.com/jawad-js/nayepankh-foundation-redesign)
The project focuses on improving the user experience, accessibility, responsiveness, and overall visual design while preserving the organization's mission and identity.

**React • Tailwind CSS**

### 🎬 [Cinema Search](https://github.com/jawad-js/cinema-search)
Movie discovery app powered by the TMDB REST API with search, movie details, responsive UI, and dynamic routing.
